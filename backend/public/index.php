...
$deliveryController = new DeliveryController(new DeliveryService(new DeliveryRepository(), $stockService, $auditRepository, new ProductSerialRepository()));
$purchaseOrderController = new PurchaseOrderController(new PurchaseOrderService(new PurchaseOrderRepository(), $stockService, $auditRepository, new PurchaseRequestRepository()));
